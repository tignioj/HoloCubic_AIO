...
static lv_obj_t *local_ip_label = NULL;
static lv_obj_t *ap_ip_label = NULL;
static lv_obj_t *domain_label = NULL;
...
// clean 内存变化47816 47548 47308
// del 内存变化49340 49080 48864 48624 48100
void server_gui_init(void)
{
    lv_obj_t *act_obj = lv_scr_act(); // 获取当前活动页
    lv_obj_clean(act_obj); // 清空此前页面

    if(NULL != main_scr) setting_gui_del();
    else main_scr = lv_obj_create(NULL);
